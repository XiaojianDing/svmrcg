function [xsup,w,d,pos,timeps,alpha,obj,ps,H,n3]=svmclassrand(x,y,c,lambda,kernel,kerneloption,verbose,span, alphainit)
...
e = ones(size(y));
 %tic
[ps,n3] = svmkernelrand(x,kernel,kerneloption);
